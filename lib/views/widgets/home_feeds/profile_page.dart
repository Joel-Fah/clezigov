                  ...
                  children: [
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (isLandScape) {
                            updateSelectedRoute(ProfileDetailsPage.routeName);
                          } else {
                            context.push(ProfileDetailsPage.routeName, extra: {
                        ...
                        child: ListTile(
                          selected: isLandScape ? profileController
                              .isRouteSelected(ProfileDetailsPage.routeName) : false,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (isLandScape) {
                            updateSelectedRoute(VerifyAccountPage.routeName);
                          } else {
                        ...
                        child: ListTile(
                          selected: isLandScape ? profileController
                              .isRouteSelected(VerifyAccountPage.routeName) : false,
                          selectedColor: widget.imageColor,
                          selectedTileColor: widget.imageColor.withOpacity(0.1),
                          shape: RoundedRectangleBorder(
                            borderRadius: borderRadius * 2,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          selected: isLandScape ? profileController
                              .isRouteSelected(CommunityActivityPage.routeName) : false,
                          selectedColor: widget.imageColor,
                          selectedTileColor: widget.imageColor.withOpacity(0.1),
                          shape: RoundedRectangleBorder(
                            borderRadius: borderRadius * 2,
                  ...
                  children: [
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          selected: isLandScape ? profileController
                              .isRouteSelected(AppearancePage.routeName) : false,
                          selectedColor: widget.imageColor,
                          selectedTileColor: widget.imageColor.withOpacity(0.1),
                          shape: RoundedRectangleBorder(
                            borderRadius: borderRadius * 2,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          selected: isLandScape ? profileController
                              .isRouteSelected(NotificationsPage.routeName) : false,
                          selectedColor: widget.imageColor,
                          selectedTileColor: widget.imageColor.withOpacity(0.1),
                          shape: RoundedRectangleBorder(
                            borderRadius: borderRadius * 2,
